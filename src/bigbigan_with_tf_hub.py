# this code is changed to a py file from ipynb tutorial of bigbigan tensorflow hub implementation.
# https://github.com/tensorflow/docs-l10n/blob/master/site/ja/hub/tutorials/bigbigan_with_tf_hub.ipynb
